...
class DataLoader():
    ...
    def __init__(self, args):
        ...
        self.id_user_dict_path = os.path.join(args.root_path, args.input_data_type, 'id_user_dict'+self.file_name)
        self.id_item_dict_path = os.path.join(args.root_path, args.input_data_type, 'id_item_dict'+self.file_name)
        self.id_word_dict_path = os.path.join(args.root_path, args.input_data_type, 'id_word_dict'+self.file_name)
        self.item_reviews_path = os.path.join(args.root_path, args.input_data_type, 'item_reviews'+self.file_name)
        self.item_real_reviews_path = os.path.join(args.root_path, args.input_data_type, 'item_real_reviews'+self.file_name)
        self.user_item_review_path = os.path.join(args.root_path, args.input_data_type, 'user_item_review'+self.file_name)
        self.train_user_purchsed_items_dict_path = os.path.join(args.root_path, args.input_data_type, 'train_user_purchased_items'+self.file_name)
        self.validation_user_purchsed_items_dict_path = os.path.join(args.root_path, args.input_data_type, 'validation_user_purchased_items'+self.file_name)
        self.test_user_purchsed_items_dict_path = os.path.join(args.root_path, args.input_data_type, 'test_user_purchased_items'+self.file_name)
        self.data_statistics_path = os.path.join(args.root_path, args.input_data_type, 'data_statistics'+self.file_name)
