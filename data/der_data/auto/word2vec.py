...
# Settings:
input_file = 'word_data.gz'   # sys.argv[1]   gz file
col = 0 #int(sys.argv[2])
outfile_embedding = 'word_emb_tmp.pkl'  #sys.argv[3]
outfile_dict = 'word_id_dict_tmp' #sys.argv[4]
outfile_dict_rev = 'id_word_dict_tmp' #sys.argv[5]
